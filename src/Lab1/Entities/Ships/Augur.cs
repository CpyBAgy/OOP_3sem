...
{
    public Augur(PhotinicallyModifiedDeflector? photinicallyModifiedDeflector = null, bool? antiNitrinoEmitter = false)
    {
        ShipsHull = new LargeHull();
        ...
        ShipDeflector = new LargeDeflector();
